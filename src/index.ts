 ...
 *
 * // Each result contains: direction (0-359), elevationAngleDegrees, distance_km
 * horizon.forEach(point => {
 *   console.log(`${point.direction}°: ${point.elevationAngleDegrees.toFixed(1)}° at ${point.distance_km.toFixed(1)}km`);
 * });
 * ```
 */
